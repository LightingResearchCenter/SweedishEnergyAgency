function [subject,startTime,stopTime,startRm1,stopRm1] = importCropLog(workbookFile,sheetName,startRow,endRow)
%IMPORTFILE Import data from a spreadsheet
%   [subject,startTime,stopTime,startRm1,stopRm1] = IMPORTFILE(FILE) reads
%   data from the first worksheet in the Microsoft Excel spreadsheet file
%   named FILE and returns the data as column vectors.
%
%   [subject,startTime,stopTime,startRm1,stopRm1] = IMPORTFILE(FILE,SHEET)
%   reads from the specified worksheet.
%
%   [subject,startTime,stopTime,startRm1,stopRm1] =
...
% Example:
%   [subject,startTime,stopTime,startRm1,stopRm1] =
%   importfile('cropLog.xlsx','Cropped Daysimeter Time',2,12);
%
%   See also XLSREAD.

% Auto-generated by MATLAB on 2014/02/24 15:06:21
